...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      style={{ zIndex: 1 }}
      className={`absolute left-0 top-[50px] z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden shadow-md bg-white duration-300 ease-linear lg:static lg:translate-x-0 ${
                        ...
                        <ul className='mt-2 mb-2 flex flex-col gap-2 pl-6'>
                          <li>
                            <NavLink
                              to='/product-category'
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2 rounded-md px-4 text-sm font-medium text-[#556ee6] duration-300 ease-in-out hover:text-blue-700 ' +
                                (isActive && '!text-white')
                              }
                            >
                              Product Category
